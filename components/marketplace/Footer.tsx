  ...
  <footer className="border-t border-border bg-card">
    <div className="container py-10">
      <div className="grid gap-8 md:grid-cols-4">
        <div>
          ...
          <p className="text-xs leading-relaxed text-muted-foreground">
            Platform SMKMarket karya siswa SMK Negeri 1 Banjarmasin untuk memfasilitasi kewirausahaan dan kreativitas pelajar.
          </p>
      ...
      <div className="mt-8 border-t border-border pt-6 text-center text-[11px] text-muted-foreground">
        &copy; {new Date().getFullYear()} SMKMarket SMK Negeri 1 Banjarmasin. Dibangun untuk pendidikan kewirausahaan.
      </div>
    </div>
  </footer>
);
