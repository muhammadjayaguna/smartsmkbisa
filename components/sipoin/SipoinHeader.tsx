...
interface SipoinHeaderProps {
  title: string;
}

export default function SipoinHeader({ title }: SipoinHeaderProps) {
      ...
      <div className="flex items-center gap-4">
        {user ? (
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center text-amber-700 font-bold border-2 border-white shadow-sm overflow-hidden">
          ...
          <Link href="/auth" className="text-sm font-medium text-amber-600 hover:text-amber-800">
            Masuk
          </Link>
        )}
      </div>
