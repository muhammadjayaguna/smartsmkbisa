 ...
 interface PeminjamanTableProps {
   data: PeminjamanBarang[] | undefined;
   isLoading: boolean;
   onAddClick: () => void;
   onEdit: (item: PeminjamanBarang) => void;
   onDelete: (id: string) => void;
   isDeleting: boolean;
  isAdmin?: boolean;
 }
 
const PeminjamanTable = ({ data, isLoading, onAddClick, onEdit, onDelete, isDeleting, isAdmin = false }: PeminjamanTableProps) => {
   return (
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Apakah Anda yakin ingin menghapus data peminjaman "{item.nama_alat}"? 
