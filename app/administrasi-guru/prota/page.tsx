...
export default function ProtaPromesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20 print:pt-[1cm] print:pb-[1cm] print:px-[1.5cm]">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200/60 no-print">
