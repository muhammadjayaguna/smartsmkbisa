    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20 print-container print:max-w-none print:w-full">
      <div className="hidden print:block w-full">
        ...
        <div className="pb-4 pt-2 text-center">
          <h2 className="text-xl font-bold uppercase underline pb-2">Data Siswa Bimbingan</h2>
        </div>
      </div>
            ...
            <table className="w-full text-sm text-left">
              <thead className="text-xs text-slate-500 bg-slate-50/50 uppercase border-b border-slate-100">
                <tr>
                  ...
                  <th className="px-6 py-4 font-bold">Kontak 2</th>
                </tr>
              </thead>
                    ...
                    <tr key={student.id} className="hover:bg-blue-50/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center text-slate-600 gap-2">
                          <Phone className="w-3.5 h-3.5" /> {student.hp || '-'}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center text-slate-600 gap-2">
                          <Phone className="w-3.5 h-3.5" /> {student.telepon || '-'}
                        </div>
                      </td>
                    </tr>
                  ))
